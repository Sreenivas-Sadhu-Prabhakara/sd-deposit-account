package com.bank.bian.depositaccount.model;
...
/**
 * The BIAN control record for this service domain: "Deposit Account Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Deposit Account Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Deposit Account Facility Fulfillment Arrangement";
